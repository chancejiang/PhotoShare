...
var CloudHook = exports.CloudHook = function(config){
...
util.inherits(CloudHook, Hook);

CloudHook.prototype._start = function(config){
...
function handleDevices(control, db, server) {
    ...
    setOAuthConfig(userDoc, deviceDoc._id, deviceDoc.oauth_creds, server, function(err) {
                    if (!err) {
                        ...
                        self.emit("activedDevice", deviceDoc._id)
                    }
                });
              }
            })
